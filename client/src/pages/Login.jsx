...
import PetCareLogo from "../assets/PetCare.png"; // Import the image
      ...
      <div className="flex flex-col items-center gap-6">
        ...
        >
          ...
          <p className="text-gray-600 text-sm text-center max-w-md">
            Because Those Who Care Deserve the Best for Their Furry Companions.
          </p>
        </form>
      </div>
    </div>
...
//                 src={PetCareLogo}
//                 alt="PetCare Logo"
//                 className="h-24" // Adjust width and height as needed
//               />
//             </div>
//             <span className="flex gap-1 py-1 px-3 border rounded-full text-sm md:text-base bordergray-300 text-gray-600">
//               Because Those Who Care Deserve the Best for Their Furry
//               Companions.
//             </span>
//           </div>
//         </div>
...
//               <span>PetCare</span>
//               <span>Routine Management Portal</span>
//             </p>
